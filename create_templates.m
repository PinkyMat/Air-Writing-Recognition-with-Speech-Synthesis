...
I=imread('letters_numbers\DD.png');J=imread('letters_numbers\J.bmp');
K=imread('letters_numbers\K.bmp');L=imread('letters_numbers\LL.bmp');
...
k=imread('letters_numbers\k.png');l=imread('letters_numbers\l.bmp');
